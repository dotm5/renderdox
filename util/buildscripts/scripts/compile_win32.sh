...
if [ ! -f ./Win32/Release/dcomp.dll ] || [ ! -f ./Win32/Release/dcompui.exe ] || [ ! -f ./Win32/Release/dcompcmd.exe ] ; then
...
if [ ! -f ./x64/Release/dcomp.dll ] || [ ! -f ./x64/Release/dcompui.exe ] || [ ! -f ./x64/Release/dcompcmd.exe ] ; then
